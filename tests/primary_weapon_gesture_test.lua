...
local PrimaryWeaponGesture = require("stalker2.primaryweapon")
...
RunTest("LH Primary Weapon Gesture Happy Case", function()
    ...
    -- Set up left hand
    local leftHandPrimaryWeapon = PrimaryWeaponGesture.primaryWeaponGestureLH
...
RunTest("RH Primary Weapon Gesture Happy Case", function()
    TestHelpers.resetTestState()
    -- Set up right hand
    local rightHandPrimaryWeapon = PrimaryWeaponGesture.primaryWeaponGestureRH
